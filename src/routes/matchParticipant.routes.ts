...
router.delete(
  ...
  /* #swagger.auto = false
    ...
    #swagger.description = '특정 게임 기록을 삭제(숨김) 처리합니다. (userUploader 이상 권한 필요) 삭제 이벤트는 guild_audit_log에 감사 기록되어 클랜관리 로그(GET /api/guildMember/{guildId}/audit-logs)에서 조회됩니다. 웹 세션 요청은 세션 사용자가 삭제자로 기록됩니다.'
